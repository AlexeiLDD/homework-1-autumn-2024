...
### 5. [Размещение объявления](https://www.vol-4-ok.ru/order)
...
#### 7.2. Раздел с объявлениями при выбранной категории
**В данном разделе расположены карточки объявлений, относящиеся к определённой категории.**
 ...
 2. Поведение карточки товара идентично поведению из [раздела 7.1.](#71-раздел-с-объявлениями)
 3. Соотношение выдачи продвинутых и непродвинуты объявлений идентично [разделу 7.1](#71-раздел-с-объявлениями)
 4. Изначальное количество карточек на странице и механизм подгрузки дополнительных карточек на страницу идентичен [разделу 7.1](#71-раздел-с-объявлениями)
...
1. Поведение карточки товара идентично поведению из [раздела 7.1.](#71-раздел-с-объявлениями)
