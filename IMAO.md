...
2. Поведение карточки товара идентично поведению из [раздела 1.1.](#11-раздел-с-объявлениями)
3. Клик по кнопке "Активные" приводит к переходу на секцию с активными объявлениями, если она не была открыта. Также подчеркивание под текстом приобретает голубой цвет
4. Клик по кнопке "Проданные" приводит к переходу на секцию с проданными объявлениями, если она не была открыта. Также подчеркивание под текстом приобретает голубой цвет. Карточки объявлений в данной вкладке имеют зелёнцю плашку с черным текстом "Продано" в правом верхнем углу карточки 
...
5. При создании нового объявления карточка с данным товаром появляется на вкладке "Активные", а счетчик активных объявлений на вкладке увеличивается
6. При покупке объявления данного продавца карточка с купленным товаром появляется на вкладке "Проданные" и исчезает с вкладки "Активные". При этом счетчик активных объявлений на вкладке уменьшается, а счетчик проданных - увеличивается
7. Если у пользователя нет активных объявлений, то вместо списка будет показано изображение с пустыми карточками товара, под ним будет располагаться соответствующая подпись. Счетчик объявлений на вкладке при этом будет показывать 0
8. Если у пользователя нет проданных объявлений, то вместо списка будет показано изображение с пустыми карточками товара, под ним будет располагаться соответствующая подпись. Счетчик объявлений на вкладке при этом будет показывать 0
